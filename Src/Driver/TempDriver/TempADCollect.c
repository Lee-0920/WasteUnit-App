...
#define ADC_CHANNELB              ADC_Channel_15   //漏液采集AD通道

#define GPIO_CHANNELA_PIN         GPIO_Pin_1		//温度采集引脚
#define GPIO_CHANNELA_PORT        GPIOC
#define GPIO_CHECKLEAKING_PIN         GPIO_Pin_5	//漏液采集引脚
#define GPIO_CHECKLEAKING_PORT        GPIOC
...
static void TempADCollect_GPIOConfiguration(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = GPIO_CHECKLEAKING_PIN;
    GPIO_Init(GPIO_CHECKLEAKING_PORT, &GPIO_InitStructure);
}
...
static void TempADCollect_ADCConfiguration(void)
{
    ...
    ADC_InitStructure.ADC_NbrOfConversion = 2;//1 个转换在规则序列中
