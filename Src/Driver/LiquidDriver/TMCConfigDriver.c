...
#define TMC_UART_TX_PIN                                 GPIO_Pin_8
#define TMC_UART_TX_PinSource                       	GPIO_PinSource8
#define TMC_UART_TX_PORT                               	GPIOD
#define TMC_UART_TX_RCC                                	RCC_AHB1Periph_GPIOD

#define TMC_UART_RX_PIN                                 GPIO_Pin_9
#define TMC_UART_RX_PinSource                       	GPIO_PinSource9
#define TMC_UART_RX_PORT                               	GPIOD
#define TMC_UART_RX_RCC                             	RCC_AHB1Periph_GPIOD
...
void TMCConfigDriver_UARTInit(void)
{
    ...
    USART_Init(TMC_UART, &USART_InitStructure);
    {
        ...
        float temp = (float) (180000000/4) / (TMC_UART_BAUD * 16);
